...
def align_chirality(smiles1, smiles2):
    try:
        ...
        if not match1 or not match2:
            print("MCS mapping failed, returning original smiles2")
            return smiles2
        ...
        # No absolute chirality—align SMILES stereochemical symbols one by one
        if len(chiral1) == 0:
            stereo1 = get_smiles_stereo_list(smiles1)
            stereo2 = get_smiles_stereo_list(smiles2)
            #print("smiles1 stereochemical symbol order:", stereo1)
            #print("smiles2 stereochemical symbol order:", stereo2)
            flip_indices = []
        ...
        # Perform standard stereochemistry alignment (based on absolute R/S configuration)
        ...
        print(f"An exception occurred, returning original smiles2: {e}")
        return smiles2
